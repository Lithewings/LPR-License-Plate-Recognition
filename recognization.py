...
def locate_license_plate(image_path):
    ...
    final_result2_dir = "valid_recognized"
    os.makedirs(final_result2_dir, exist_ok=True)
    cv2.imwrite('valid_recognized/plate_located.png', candidate_img)
...
def predict_characters(model, characters_folder):
    ...
    candidate_img = cv2.imread("valid_recognized/plate_located.png")
...
if __name__ == "__main__":
    ...
    main("model/new_model_20260625_190227.keras")
